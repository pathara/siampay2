...
!function(a) {
    ...
    b.prototype= {
        constructor: b, namespace: "featherlight", targetAttr: "data-featherlight", variant: null, resetCss: !1, background: null, openTrigger: "click", closeTrigger: "click", filter: null, root: "body", openSpeed: 250, closeSpeed: 250, closeOnClick: "background", closeOnEsc: !0, closeIcon: "&#10005;", loading: "", otherClose: null, beforeOpen: a.noop, beforeContent: a.noop, beforeClose: a.noop, afterOpen: a.noop, afterContent: a.noop, afterClose: a.noop, onKeyUp: a.noop, onResize: a.noop, type: null, contentFilters: ["jquery", "image", "html", "ajax", "iframe", "text"], setup: function(b, c) {
            ...
            f=a(d.background||['<div class="'+e+"-loading "+e+'">',
            '<div class="'+e+'-content">',
            ...
            d.$instance.on(d.closeTrigger+"."+d.namespace,
            function(b) {
                var c=a(b.target);
    ...
    a.extend(b,
    {
        id:0, autoBind:"[data-featherlight]", defaults:b.prototype, contentFilters: {
            ...
            ,
            image: {
                regex: /\.(png|jpg|jpeg|gif|tiff|bmp)(\?\S*)?$/i, process: function(b) {
        ...
        readElementConfig:function(b) {
            ...
            return b&&b.attributes&&a.each(b.attributes, function() {
                ...
                if(b) {
                    var e=this.value, f=a.camelCase(b[1]);
        ...
        d) {
            ...
            return b.on(f.openTrigger+"."+f.namespace, f.filter, function(f) {
                ...
                ,
                e.readElementConfig(b[0]),
                e.readElementConfig(this),
                d);
                new e(c,
                g).open(f)
            }
