...
$('.m3title2sub4').attr('href', 'บริการเชื่อมต่อ PayPal.html');*/
$('.sub3').addClass('hide');
...
$('.m3title4sub2').html('บริการชำระเงินด้วยระบบสมาชิก');
...
/** Scroll-function.js **/
$(function(){function s(){return window.pageYOffset}var n=37;$(window).scroll(function(){var a=s();a>=n?($(".topnav").css("margin-top","-45px"),$(".navbar-brand").addClass("navbar-brandAni"),$(".navbar-custom").addClass("navbar-customAni"),$(".getstarted").addClass("getstartedAni"),$(".main-nav").addClass("main-navAni"),$(".nav-mobile").addClass(".nav-mobile-height"),$(".arrow-nav").css("position","absolute"),$(".content").addClass("contentAni"),$(".arrow-nav").addClass("arrow-navAni"),$(".content_services").css("top","-14px"),$(".content_services").css("border-radius","0px 0px 8px 8px"),$(".content_about").css("top","-14px"),$(".content_about").css("border-radius","0px 0px 8px 8px"),$(".content_resources").css("top","-14px"),$(".content_resources").css("border-radius","0px 0px 8px 8px")):($(".topnav").css("margin-top","0px"),$(".navbar-brand").removeClass("navbar-brandAni"),$(".navbar-custom").removeClass("navbar-customAni"),$(".getstarted").removeClass("getstartedAni"),$(".main-nav").removeClass("main-navAni"),$(".arrow-nav").css("position","absolute"),$(".content").removeClass("contentAni"),$(".arrow-nav").removeClass("arrow-navAni"),$(".content_about").css("top","-15px"),$(".content_about").css("border-radius","8px"),$(".content_resources").css("top","-15px"),$(".content_resources").css("border-radius","8px"),$(".content_services").css("top","-15px"),$(".content_services").css("border-radius","8px"))})}),$(function(){function s(){return window.pageYOffset}var n=1;$(window).scroll(function(){var a=s();a>=n?$(".vidcss").css("display","none"):$(".vidcss").css("display","block")})});
